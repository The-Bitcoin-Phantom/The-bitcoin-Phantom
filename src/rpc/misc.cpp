...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given bitphantom address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitphantom address to validate"},
                },
                RPCResult{
            "{\n"
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitphantom address to use for the signature."},
