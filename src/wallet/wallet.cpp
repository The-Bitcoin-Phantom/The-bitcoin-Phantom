    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/bitphantom/bitphantom/pull/14711#issuecomment-458342518
 ...
 * https://bitphantomtalk.org/?topic=54527, or
 * https://github.com/bitphantom/bitphantom/pull/1393.
 */
