...
#ifndef bitphantom_CRYPTO_CHACHA_POLY_AEAD_H
#define bitphantom_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitphantom.
 *
 ...
 *
 * The chacha20-poly1305@bitphantom combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitphantom cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitphantom are relatively fast in
...
#endif // bitphantom_CRYPTO_CHACHA_POLY_AEAD_H
