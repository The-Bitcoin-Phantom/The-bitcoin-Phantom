...
static void SetupbitphantomTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitphantom-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitphantom-tx [options] <hex-tx> [commands]  Update hex-encoded bitphantom transaction\n" +
            "or:     bitphantom-tx [options] -create [commands]   Create hex-encoded bitphantom transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitphantom transaction
