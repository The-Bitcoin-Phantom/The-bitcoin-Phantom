...
void WalletView::setbitphantomGUI(bitphantomGUI *gui)
{
    if (gui)
    {
        ...
        connect(overviewPage, &OverviewPage::transactionClicked, gui, &bitphantomGUI::gotoHistoryPage);

        // Navigate to transaction history page after send
        connect(sendCoinsPage, &SendCoinsDialog::coinsSent, gui, &bitphantomGUI::gotoHistoryPage);
        ...
        connect(this, &WalletView::encryptionStatusChanged, gui, &bitphantomGUI::updateWalletStatus);

        // Pass through transaction notifications
        connect(this, &WalletView::incomingTransaction, gui, &bitphantomGUI::incomingTransaction);

        // Connect HD enabled state signal
        connect(this, &WalletView::hdEnabledStatusChanged, gui, &bitphantomGUI::updateWalletStatus);
    }
}
