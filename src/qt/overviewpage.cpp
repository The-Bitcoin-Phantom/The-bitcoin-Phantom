...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(bitphantomUnits::BTC),
...
void OverviewPage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    if (walletModel->privateKeysDisabled()) {
        ui->labelBalance->setText(bitphantomUnits::formatWithUnit(unit, balances.watch_only_balance, false, bitphantomUnits::separatorAlways));
        ui->labelUnconfirmed->setText(bitphantomUnits::formatWithUnit(unit, balances.unconfirmed_watch_only_balance, false, bitphantomUnits::separatorAlways));
        ui->labelImmature->setText(bitphantomUnits::formatWithUnit(unit, balances.immature_watch_only_balance, false, bitphantomUnits::separatorAlways));
        ui->labelTotal->setText(bitphantomUnits::formatWithUnit(unit, balances.watch_only_balance + balances.unconfirmed_watch_only_balance + balances.immature_watch_only_balance, false, bitphantomUnits::separatorAlways));
    } else {
