...
//! Entry point for bitphantomApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &bitphantomApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for bitphantomGUI tests.
void AppTests::guiTests(bitphantomGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &bitphantomGUI::consoleShown, this, &AppTests::consoleTests);
