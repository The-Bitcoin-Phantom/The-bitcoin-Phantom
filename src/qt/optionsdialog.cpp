    ...
    mapper(nullptr)
{
    ...
    ui->bitphantomAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitphantomAtStartup);
    ...
    ui->bitphantomAtStartup->setToolTip(ui->bitphantomAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitphantomAtStartup->setText(ui->bitphantomAtStartup->text().arg(PACKAGE_NAME));

    ui->openbitphantomConfButton->setToolTip(ui->openbitphantomConfButton->toolTip().arg(PACKAGE_NAME));
