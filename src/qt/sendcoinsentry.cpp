    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitphantom address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitphantom address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &bitphantomAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
