...
#ifndef bitphantom_QT_bitphantomUNITS_H
#define bitphantom_QT_bitphantomUNITS_H
...
/** bitphantom unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class bitphantomUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit bitphantomUnits(QObject *parent);

    /** bitphantom units.
      @note Source: https://en.bitphantom.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef bitphantomUnits::Unit bitphantomUnit;

#endif // bitphantom_QT_bitphantomUNITS_H
