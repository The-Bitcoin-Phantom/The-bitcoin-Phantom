...
#ifndef bitphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define bitphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // bitphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
