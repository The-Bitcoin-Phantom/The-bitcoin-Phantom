...
{
    BOOST_CHECK(TestSplitHost("www.bitphantomcore.org", "www.bitphantomcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitphantomcore.org]", "www.bitphantomcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitphantomcore.org:80", "www.bitphantomcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitphantomcore.org]:80", "www.bitphantomcore.org", 80));
