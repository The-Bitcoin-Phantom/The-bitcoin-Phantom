...
#ifndef bitphantom_TEST_SCRIPTNUM10_H
#define bitphantom_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from bitphantom Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // bitphantom_TEST_BIGNUM_H
