...
// bitphantom includes.
#include <..\src\script\bitphantomconsensus.h>
...
int main()
{
    std::cout << "bitphantomconsensus version: " << bitphantomconsensus_version() << std::endl;
    ...
    auto op0Result = bitphantomconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitphantomconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
