...
libs = [
    'libbitphantom_cli',
    'libbitphantom_common',
    'libbitphantom_crypto',
    'libbitphantom_server',
    'libbitphantom_util',
    'libbitphantom_wallet_tool',
    'libbitphantom_wallet',
    'libbitphantom_zmq',
    'bench_bitphantom',
]
...
def main():
    parser = argparse.ArgumentParser(description='bitphantom-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitphantom_config.h'), os.path.join(SOURCE_DIR, 'config/bitphantom-config.h'))
