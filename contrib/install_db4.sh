...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitphantom repository."
  exit 1
fi
...
# See https://github.com/bitphantom/bitphantom/issues/16064
...
echo 'When compiling bitphantomd, run `./configure` in the following way:'
echo
