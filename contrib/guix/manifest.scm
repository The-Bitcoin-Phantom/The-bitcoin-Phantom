...
(define* (make-bitphantom-cross-toolchain target
                                  #:key
...
desirable for building bitphantom Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-bitphantom-cross-toolchain "i686-linux-gnu")
       (make-bitphantom-cross-toolchain "x86_64-linux-gnu")
       (make-bitphantom-cross-toolchain "aarch64-linux-gnu")
       (make-bitphantom-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-bitphantom-cross-toolchain "riscv64-linux-gnu"
