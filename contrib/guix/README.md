# Bootstrappable bitphantom Core Builds

This directory contains the files necessary to perform bootstrappable bitphantom
Core builds.
...
- 24GB of free disk space on the partition that the bitphantom Core git repository
  resides in
...
For a bitphantom Core depends development environment, simply invoke
...
From the top of a clean bitphantom Core repository:
...
To use dongcarl's substitute server for bitphantom Core builds after having
