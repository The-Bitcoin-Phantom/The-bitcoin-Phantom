...
[good first issue](https://github.com/bitphantom/bitphantom/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.

Communication Channels
----------------------

Most communication about bitphantom Core development happens on IRC, in the
#bitphantom-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/bitphantom-core-dev/](http://www.erisian.com.au/bitphantom-core-dev/)
and [http://gnusha.org/bitphantom-core-dev/](http://gnusha.org/bitphantom-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/bitphantom-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitphantom-qt
  ...
  - `test` for changes to the bitphantom unit tests or QA tests
...
[Translation Process](https://github.com/bitphantom/bitphantom/blob/master/doc/translation_process.md)
