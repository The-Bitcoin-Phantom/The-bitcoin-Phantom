...
This document provides guidelines for internationalization of the bitphantom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitphantom_en.ts` remains unchanged.
