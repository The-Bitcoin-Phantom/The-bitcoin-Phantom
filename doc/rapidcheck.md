# RapidCheck property-based testing for bitphantom Core

## Concept

Property-based testing is experimentally being added to bitphantom Core with
...
If RapidCheck is installed, bitphantom Core will automatically run the
...
3. Configure bitphantom Core with RapidCheck.

    `cd` to the directory of your local bitphantom repository and run
...
4. Build bitphantom Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_bitphantom-crypto_gen.o
    CXX      test/test_bitphantom-key_properties.o
    ```
...
That's it! You are now running property-based tests in bitphantom Core.
