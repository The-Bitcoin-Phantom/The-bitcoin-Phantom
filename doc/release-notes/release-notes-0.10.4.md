bitphantom Core version 0.10.4 is now available from:

  <https://bitphantom.org/bin/bitphantom-core-0.10.4/>
...
- #6953 `43c2789` Split bitphantom-tx into its own package
- #6953 `dfe0d4d` Include bitphantom-tx binary on Debian/Ubuntu
