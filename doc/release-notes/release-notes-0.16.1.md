bitphantom Core version 0.16.1 is now available from:

  <https://bitphantomcore.org/bin/bitphantom-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitphantomd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitphantomd processes are cleaned up when tests end (sdaftuar)
