bitphantom Core version 0.9.4 is now available from:

  https://bitphantom.org/bin/0.9.4/
...
this update is incompatible with the bitphantom system and could lead to consensus
forks.

bitphantom Core released binaries from https://bitphantom.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitphantom/+archive/ubuntu/bitphantom
- A third-party or self-compiled bitphantom Core

upgrade to bitphantom Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
