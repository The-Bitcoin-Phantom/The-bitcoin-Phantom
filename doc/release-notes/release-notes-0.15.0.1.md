bitphantom Core version *0.15.0.1* is now available from:

  <https://bitphantom.org/bin/bitphantom-core-0.15.0.1/>

and

  <https://bitphantomcore.org/bin/bitphantom-core-0.15.0.1/>
