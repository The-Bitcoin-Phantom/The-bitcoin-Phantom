bitphantom-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitphantom/files/bitphantom/bitphantom-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the bitphantom
...
New/changed settings (command-line or bitphantom.conf file)
--------------------------------------------------------
