bitphantom Core version 0.14.1 is now available from:

  <https://bitphantom.org/bin/bitphantom-core-0.14.1/>
...
- #10130 `ecc5232` bitphantom-tx input verification (awemany, jnewbery)
