bitphantom version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitphantom/files/bitphantom/bitphantom-0.5.4/
...
http://gitorious.org/bitphantom/bitphantomd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix bitphantom-Qt notifications under Growl 1.3.
Increase required age of bitphantom-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbitphantom properly when installing bitphantom-Qt over it. (Windows)
