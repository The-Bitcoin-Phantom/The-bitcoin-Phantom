bitphantom Core version *0.15.2* is now available from:

  <https://bitphantomcore.org/bin/bitphantom-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitphantom-tx (TheBlueMatt)
