bitphantom Core version 0.13.2 is now available from:

  <https://bitphantom.org/bin/bitphantom-core-0.13.2/>
...
- #8908 `4a974b2` Update bitphantom-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitphantom-tx to create v2 transactions (btcdrak)
