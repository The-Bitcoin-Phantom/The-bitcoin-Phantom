bitphantom Core version 0.14.2 is now available from:

  <https://bitphantom.org/bin/bitphantom-core-0.14.2/>
...
(in bitphantom Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate bitphantom-config.h as necessary (theuni)
