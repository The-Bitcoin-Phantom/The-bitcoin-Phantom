bitphantom Core version 0.16.3 is now available from:

  <https://bitphantomcore.org/bin/bitphantom-core-0.16.3/>
...
been discovered in bitphantom Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` bitphantomconsensus: invalid flags error should be set to `bitphantomconsensus_err` (afk11)
