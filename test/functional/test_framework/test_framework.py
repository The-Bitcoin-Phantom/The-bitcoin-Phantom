...
class bitphantomTestFramework(metaclass=bitphantomTestMetaClass):
    ...
    def add_nodes(self, num_nodes, extra_args=None, *, rpchost=None, binary=None):
        ...
        for i in range(num_nodes):
            self.nodes.append(TestNode(
                ...
                bitphantomd=binary[i],
                bitphantom_cli=self.options.bitphantomcli,
    ...
    def _initialize_chain(self):
        ...
        if not os.path.isdir(cache_node_dir):
            ...
            self.nodes.append(
                TestNode(
                    ...
                    rpchost=None,
                    timewait=self.rpc_timeout,
                    bitphantomd=self.options.bitphantomd,
                    bitphantom_cli=self.options.bitphantomcli,
                    coverage_dir=None,
                    cwd=self.options.tmpdir,
                ))
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain)  # Overwrite port/rpcport in bitphantom.conf
