...
"""Verify that starting bitphantom with -h works as expected."""

from test_framework.test_framework import bitphantomTestFramework
from test_framework.util import assert_equal

class HelpTest(bitphantomTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitphantom with -h for help text")
        ...
        self.log.info("Start bitphantom with -version for version information")
        ...
        self.log.info("Start bitphantomd with -fakearg to make sure it does not start")
