...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/bitphantom/bitphantom/pull/14884#discussion_r239585126).
...
with the bitphantomd(s) being tested in a callback-based event loop; the other
