...
By default, bitphantomd will dump mempool on shutdown and
...
class MempoolPersistTest(bitphantomTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitphantomd from writing mempool.dat to disk. Verify that `savemempool` fails")
