#!/usr/bin/env python3
# Copyright (c) 2014-2019 The bitphantom Core developers
...
class WalletTest(bitphantomTestFramework):
    ...
    def run_test(self):
        ...
        # This will raise an exception for attempting to get the private key of an invalid bitphantom address
        assert_raises_rpc_error(-5, "Invalid bitphantom address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid bitphantom address
        assert_raises_rpc_error(-5, "Invalid bitphantom address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid bitphantom address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitphantom/bitphantom/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
