...
class P2PPermissionsTests(bitphantomTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitphantomconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].bitphantomconf, 'w', encoding="utf8") as f:
            f.write(newText)
